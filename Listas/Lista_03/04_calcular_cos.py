...
def calcular_cos(x, numero_de_iteracoes):
  """
  Calcula a aproximação de cos(x) usando a série de Taylor.
  ...
  print(f"Aproximação de cos({x:.2f}) com {numero_de_iteracoes} iterações: {soma:.4f}")
...
calcular_cos(x, numero_de_iteracoes)
